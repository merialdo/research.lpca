...
def save(dataset, write_separator=";"):
    ...
    output_filepath = os.path.join(dataset.home, TEST_FACTS_WITH_MAXIMAL_CLIQUE_SIZE_FILENAME)
...
def read(dataset_name, read_separator=";", return_fact_2_clique_size=False):
    ...
    filepath = os.path.join(datasets.home_folder_for(dataset_name), TEST_FACTS_WITH_MAXIMAL_CLIQUE_SIZE_FILENAME)
